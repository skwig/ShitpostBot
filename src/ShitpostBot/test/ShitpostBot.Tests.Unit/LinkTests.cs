...
public class LinkTests
{
    ...
    [InlineData(
        "https://www.youtube.com/watch?v=eusx0VW-m3M&t=60",
    ...
    [InlineData(
        "https://steamcommunity.com/sharedfiles/filedetails/?id=505736710",
        LinkProvider.SteamWorkshop,
        "505736710"
    )]
    [InlineData(
        "https://steamcommunity.com/sharedfiles/filedetails/?id=2067312913",
        LinkProvider.SteamWorkshop,
        "2067312913"
    )]
    [InlineData(
        "https://www.idnes.cz/hry/magazin/stars-of-blood-valve-zrusena-hra.A211104_215739_bw-magazin_oma",
        LinkProvider.Generic,
        "hry/magazin/stars-of-blood-valve-zrusena-hra.A211104_215739_bw-magazin_oma"
    )]
    ...
    public void CreateOrDefault(
        string linkUri,
        LinkProvider? expectedLinkProvider,
