    ...
    : BotCommandFeature
{
    ...
    public override string? HelpMessage => "`repost match all [cos|l2]` - shows maximum cosine similarity of the replied post with existing posts";
        ...
        CancellationToken ct)
    {
        ...
        await chatClient.SendMessage(destination, $"Starting to match. Čekej píčo {chatClient.Utils.Emoji(":PauseChamp:")} ...");
